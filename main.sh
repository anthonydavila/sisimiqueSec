...
# Función para mostrar la advertencia y solicitar confirmación
mostrar_advertencia() {
    echo -e "\e[1;31m#######################################################"
    echo -e "#                                                     #"
    echo -e "#                  ¡ADVERTENCIA!                      #"
    echo -e "#                                                     #"
    echo -e "# Este script se proporciona \"tal cual\", sin garantías #"
    echo -e "# de ningún tipo, expresas o implícitas.              #"
    echo -e "# El autor no se hace responsable de ningún daño      #"
    echo -e "# directo, indirecto, incidental, especial,           #"
    echo -e "# consecuente o ejemplar que resulte del uso o la     #"
    echo -e "# imposibilidad de uso de este script, incluso si se  #"
    echo -e "# ha informado de la posibilidad de tales daños.      #"
    echo -e "# El uso de este script es bajo su propio riesgo.     #"
    echo -e "# Al ejecutar este script, usted acepta liberar al    #"
    echo -e "# autor de cualquier responsabilidad que pueda       #"
    echo -e "# surgir.                                             #"
    echo -e "# Se recomienda encarecidamente revisar y entender    #"
    echo -e "# el código antes de ejecutarlo.                      #"
    echo -e "#                                                     #"
    echo -e "#######################################################\e[0m"
    
    # Preguntar al usuario si desea continuar
    read -p "¿Desea continuar bajo su propia responsabilidad? (s/n): " opcion
    if [[ $opcion == "s" || $opcion == "S" ]]; then
        echo "Continuando con el resto del código..."
...
# Llamar a la función de advertencia
mostrar_advertencia
...
echo -e "\e[1;95m.---------------------------------------------------------------.\e[0m"
echo -e "\e[1;95m|                                                               |\e[0m"
echo -e "\e[1;95m| \e[1;31m███████╗██╗███████╗██╗███╗   ███╗██╗ ██████╗ ██╗   ██╗███████╗\e[1;95m|\e[0m"
echo -e "\e[1;95m| \e[1;31m██╔════╝██║██╔════╝██║████╗ ████║██║██╔═══██╗██║   ██║██╔════╝\e[1;95m|\e[0m"
echo -e "\e[1;95m| \e[1;31m███████╗██║███████╗██║██╔████╔██║██║██║   ██║██║   ██║█████╗  \e[1;95m|\e[0m"
echo -e "\e[1;95m| \e[1;31m╚════██║██║╚════██║██║██║╚██╔╝██║██║██║▄▄ ██║██║   ██║██╔══╝  \e[1;95m|\e[0m"
echo -e "\e[1;95m| \e[1;31m███████║██║███████║██║██║ ╚═╝ ██║██║╚██████╔╝╚██████╔╝███████╗\e[1;95m|\e[0m"
echo -e "\e[1;95m| \e[1;31m╚══════╝╚═╝╚══════╝╚═╝╚═╝     ╚═╝╚═╝ ╚══▀▀═╝  ╚═════╝ ╚══════╝\e[1;95m|\e[0m"
echo -e "\e[1;95m|                                                               |\e[0m"
echo -e "\e[1;95m|                        Hecho por Fdev                         |\e[0m"
echo -e "\e[1;95m'---------------------------------------------------------------'\e[0m"
}
